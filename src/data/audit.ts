...
export const AUDIT_EVENTS: AuditEvent[] = [
  { id: 'AE001', timestamp: h(8),   action: 'REFERRAL_CREATED',    actorId: 'user-001',  actorName: 'Priya Sharma',     actorRole: 'USER',         targetType: 'REFERRAL', targetId: 'REF-003', targetLabel: 'REF-003 — Trauma', details: { status: 'PENDING' } },
  ...
  { id: 'AE006', timestamp: h(3),   action: 'REFERRAL_CREATED',    actorId: 'user-001',  actorName: 'Priya Sharma',     actorRole: 'USER',         targetType: 'REFERRAL', targetId: 'REF-002', targetLabel: 'REF-002 — Obstetric' },
  ...
  { id: 'AE010', timestamp: m(45),  action: 'REFERRAL_CREATED',    actorId: 'user-001',  actorName: 'Priya Sharma',     actorRole: 'USER',         targetType: 'REFERRAL', targetId: 'REF-001', targetLabel: 'REF-001 — Cardiac' },
