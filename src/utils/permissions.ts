...
const ROLE_PERMISSIONS: Record<UserRole, readonly AstraPermission[]> = {
  HOSPITAL_OPS: ['VIEW_INCOMING_REFERRALS', 'ROUTE_TO_CLINICAL', 'MARK_ARRIVED', 'COMPLETE_REFERRAL', 'CREATE_REFERRAL'],
  DOCTOR: ['VIEW_CLINICAL_REFERRALS', 'ACCEPT_REFERRAL', 'DECLINE_REFERRAL', 'REQUEST_MORE_INFORMATION', 'CLINICAL_OVERRIDE'],
  ADMIN: ['VIEW_ALL_REFERRALS', 'VIEW_ESCALATIONS', 'VERIFY_CAPABILITY', 'VIEW_AUDIT_LOG', 'ADMIN_INTERVENTION', 'CREATE_REFERRAL'],
}
